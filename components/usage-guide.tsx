      ...
      <DialogContent className="share-dialog">
        ...
        <div className="usage-guide">
          <section>
            <h3>集中核查投稿状态</h3>
            <p>
              在工作台点击「投稿系统总览」，默认查看正在投稿或审稿中的稿件。点击「选择展示其余稿件」后，可查看准备中和已归档记录。也可点击「一键打开全部」，当前显示范围内的有效链接去重后打开；浏览器拦截时请允许本站弹出窗口。逐篇点击「打开投稿系统」，在新标签页自行登录。核查后可点击「更新记录」手动保存进展。缺少链接时点击「补充
              / 修改链接」。总览不会自动登录或抓取状态；只有主动点击一键打开按钮时才批量打开网页。
            </p>
          </section>
          <section>
            <h3>卜卦·投稿时间</h3>
            <p>
              在工作台打开「卜卦·投稿时间」，填写中文或英文论文题目 /
              摘要。系统只在本地匹配少量主题词和方法词，并把文本指纹与北京时间、农历时间结合，给出未来
              7
              天内的趣味参考时段；展开结果可查看匹配词和计算过程。它不预测录用结果，也不能替代投稿截止日期和实际准备情况。
            </p>
          </section>
          <section>
            <h3>联系作者</h3>
